...
class User extends Authenticatable
{
    ...
    public function assignedPurchaseRequests(): HasMany
    {
        return $this->hasMany(PurchaseRequest::class, 'assigned_pic_id');
    }
    ...
    {
        return $this->hasMany(PurchaseRequest::class, 'final_approver_id');
    }
